...
public class IdFindDialog extends JDialog {
	...
	private void createPWFinder() {
		...
		//JLabel PurposeLabel = new LabelForeGround(new LabelFont(new LabelBound(new JLabel("멤버 비밀번호 찾기"), 12, 10, 410, 15),"굴림",12,Font.PLAIN),0,102,51),255,255,255).getLabel();
		//pnPwFind.add(PurposeLabel);

		JLabel DescriptLabel = new LabelBound(new JLabel("본인정보에 등록한 핸드폰번호와 입력한 핸드폰번호가 같아야합니다"), 12, 35, 410, 15).getLabel();
		pnPwFind.add(DescriptLabel);

		JLabel DescriptLabel2 = new LabelBound(new JLabel("본인정보에 등록한 핸드폰번호와 입력한 핸드폰번호가 같아야합니다"), 12, 54, 410, 15).getLabel();
		...
		JLabel lbId = new LabelHorizon(new LabelBound(new JLabel("아이디"), 12, 104, 72, 15)).getLabel();
		lbId.setFont(f3);
		lbId.setForeground(new Color(238,130,238));
		pnPwFind.add(lbId);

		JLabel lbPhone2 = new LabelHorizon(new LabelBound(new JLabel("핸드폰번호"), 12, 135, 72, 15)).getLabel();
		lbPhone2.setFont(f3);
		...
		JButton btnPwFind = new ButtonBound(new ButtonForeGround(new ButtonBackGround(new JButton("비밀번호 찾기"),255, 182, 193 ),255,255,255), 223,208,116,23).getButton();
		btnPwFindFunction(btnPwFind);
		pnPwFind.add(btnPwFind);

		JButton btnPwCancel = new ButtonBound(new ButtonForeGround(new ButtonBackGround(new JButton("취소"),255, 182, 193 ),255,255,255), 351,208,71,23).getButton();
		...
		JButton btnPwCode = new ButtonBound (new ButtonBackGround(new JButton("인증번호"),255,255,255 ), 334,131,88,23).getButton();
	...
	private void createIDFinder() {
		...
		JLabel lbName = new LabelHorizon (new LabelBound(new JLabel("이름"), 12, 104, 72, 15)).getLabel();
		lbName.setFont(f3);
		lbName.setForeground(new Color(238,130,238));
		pnIdFind.add(lbName);

		JLabel lbPhone = new LabelHorizon(new LabelBound(new JLabel("핸드폰번호"), 12, 135, 72, 15)).getLabel();
		lbPhone.setFont(f3);
		...
		JButton btnCode =  new ButtonBound (new ButtonBackGround(new JButton("인증번호"),255,255,255 ), 334,131,88,23).getButton();
...
//		txtCode.setEnabled(false);
		...
		//JLabel TitleIDfinderLabel = new LabelBackGround(new LabelForeGround(new LabelFont(new LabelBound(new JLabel("멤버 아이디 찾기"), 12, 10, 410, 15),"굴림",12,Font.PLAIN),0,102,51),255,255,255).getLabel();
		//pnIdFind.add(TitleIDfinderLabel);

		JLabel DescriptIDfinderLabel = new  LabelBound(new JLabel("본인정보에 등록한 핸드폰번호와 입력한 핸드폰번호가 같아야합니다"), 12, 35, 410, 15).getLabel();
		pnIdFind.add(DescriptIDfinderLabel);

		JLabel DescriptIDfinderLabel2 = new LabelBound(new JLabel("본인정보에 등록한 핸드폰번호와 입력한 핸드폰번호가 같아야합니다"), 12, 54, 410, 15).getLabel();
		...
		JButton btnCancel =  new ButtonBound (new ButtonForeGround(new ButtonBackGround(new JButton("취소"),255, 182, 193 ),255, 255, 255), 351,208,71,23).getButton();
		pnIdFind.add(btnCancel);
		btnCancel.setFont(f3);

		JButton btnIdFind =  new ButtonBound (new ButtonForeGround(new ButtonBackGround(new JButton("아이디 찾기"),255, 182, 193 ),255, 255, 255), 223, 208, 116, 23).getButton();
	...
	private void createMenuBar() {
		...
		JButton btnFindId = new ButtonBackGround(new JButton("아이디 찾기"),255, 255, 255).getButton();
		btnFindIdFunction(btnFindId);
		menuBar.add(btnFindId);

		JButton btnFindPw = new ButtonBackGround(new JButton("비밀번호 찾기"),255, 255, 255).getButton();
