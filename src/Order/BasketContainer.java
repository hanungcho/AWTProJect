...
public class BasketContainer extends JPanel
{
	...
	public BasketContainer(MenuFrame frm)
	{
	...
	// 총가격 업데이트
	public static void updateTotalPrice(MenuFrame frm)
	{
		int tPrice = 0;
	...
	public static boolean removeOneProduct(MenuFrame frm, Product product)
	{
