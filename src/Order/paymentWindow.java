...
import DB.MemberDB;
import DB.ProductDB;
import Order.BasketPanel;
import Order.MenuFrame;
import Pay.Facade;
import Pay.paymentAgreeWindow;
import Order.BasketContainer;
import Frame.Home;
import ButtonDecorate.JButtonCreator;
import LabelDecorate.JLabelCreator;
...
public class paymentWindow extends JFrame {
	...
	public paymentWindow() {
		this.mgr = new MemberDB();
		this.fr= new Home();
		member =mgr.getOneMemberByLogin(Home.Login);
		member = new Member("name", "login", "password", "email" ,"Phone","birth",1);
		//labelCreator = new JLabelCreator();
		//btnCreator = new JButtonCreator();

		setTitle("결제"); //����ī�� ����ȭ��
		setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\Administrator\\Desktop\\starbucks-master\\images\\icons\\icon_card.jpg"));
